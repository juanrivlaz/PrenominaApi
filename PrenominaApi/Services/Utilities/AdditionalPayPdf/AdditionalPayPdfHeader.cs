...
{
    public class AdditionalPayPdfHeader : AbstractPdfDocumentEventHandler
    {
        ...
        public AdditionalPayPdfHeader(Document doc, string companyName, string rfc)
        {
            this.doc = doc;
        ...
        protected override void OnAcceptedEvent(AbstractPdfDocumentEvent @event)
        {
            ...
            canvas.SetFont(font).SetFontSize(8).ShowTextAligned("Reporte de Pagos Adicionales", coordRight, coordTop, iText.Layout.Properties.TextAlignment.RIGHT).Close();
            canvas.SetFont(font!)
                .SetFontSize(8)
